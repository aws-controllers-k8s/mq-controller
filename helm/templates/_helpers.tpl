...
{{- define "ack-mq-controller.app.name" -}}
...
*/}}
{{- define "ack-mq-controller.app.fullname" -}}
...
{{- define "ack-mq-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-mq-controller.service-account.name" -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}

{{- define "ack-mq-controller.watch-namespace" -}}
...
{{- define "ack-mq-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}
...
{{- define "ack-mq-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-mq-controller.feature-gates" -}}
{{- $list := list -}}
