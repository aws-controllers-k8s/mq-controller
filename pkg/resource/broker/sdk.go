...
func (rm *resourceManager) sdkFind(
	...
	if resp.DataReplicationMode != "" {
		ko.Spec.DataReplicationMode = aws.String(string(resp.DataReplicationMode))
	} else {
		ko.Spec.DataReplicationMode = nil
	}
...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.DataReplicationMode != nil {
		res.DataReplicationMode = svcsdktypes.DataReplicationMode(*r.ko.Spec.DataReplicationMode)
	}
	if r.ko.Spec.DataReplicationPrimaryBrokerARN != nil {
		res.DataReplicationPrimaryBrokerArn = r.ko.Spec.DataReplicationPrimaryBrokerARN
	}
	...
	if r.ko.Spec.EncryptionOptions != nil {
		f8 := &svcsdktypes.EncryptionOptions{}
		if r.ko.Spec.EncryptionOptions.KMSKeyID != nil {
			f8.KmsKeyId = r.ko.Spec.EncryptionOptions.KMSKeyID
		}
		if r.ko.Spec.EncryptionOptions.UseAWSOwnedKey != nil {
			f8.UseAwsOwnedKey = r.ko.Spec.EncryptionOptions.UseAWSOwnedKey
		}
		res.EncryptionOptions = f8
	}
	...
	if r.ko.Spec.LDAPServerMetadata != nil {
		f12 := &svcsdktypes.LdapServerMetadataInput{}
		if r.ko.Spec.LDAPServerMetadata.Hosts != nil {
			f12.Hosts = aws.ToStringSlice(r.ko.Spec.LDAPServerMetadata.Hosts)
		}
		if r.ko.Spec.LDAPServerMetadata.RoleBase != nil {
			f12.RoleBase = r.ko.Spec.LDAPServerMetadata.RoleBase
		}
		if r.ko.Spec.LDAPServerMetadata.RoleName != nil {
			f12.RoleName = r.ko.Spec.LDAPServerMetadata.RoleName
		}
		if r.ko.Spec.LDAPServerMetadata.RoleSearchMatching != nil {
			f12.RoleSearchMatching = r.ko.Spec.LDAPServerMetadata.RoleSearchMatching
		}
		if r.ko.Spec.LDAPServerMetadata.RoleSearchSubtree != nil {
			f12.RoleSearchSubtree = r.ko.Spec.LDAPServerMetadata.RoleSearchSubtree
		}
		if r.ko.Spec.LDAPServerMetadata.ServiceAccountPassword != nil {
			f12.ServiceAccountPassword = r.ko.Spec.LDAPServerMetadata.ServiceAccountPassword
		}
		if r.ko.Spec.LDAPServerMetadata.ServiceAccountUsername != nil {
			f12.ServiceAccountUsername = r.ko.Spec.LDAPServerMetadata.ServiceAccountUsername
		}
		if r.ko.Spec.LDAPServerMetadata.UserBase != nil {
			f12.UserBase = r.ko.Spec.LDAPServerMetadata.UserBase
		}
		if r.ko.Spec.LDAPServerMetadata.UserRoleName != nil {
			f12.UserRoleName = r.ko.Spec.LDAPServerMetadata.UserRoleName
		}
		if r.ko.Spec.LDAPServerMetadata.UserSearchMatching != nil {
			f12.UserSearchMatching = r.ko.Spec.LDAPServerMetadata.UserSearchMatching
		}
		if r.ko.Spec.LDAPServerMetadata.UserSearchSubtree != nil {
			f12.UserSearchSubtree = r.ko.Spec.LDAPServerMetadata.UserSearchSubtree
		}
		res.LdapServerMetadata = f12
	}
	if r.ko.Spec.Logs != nil {
		f13 := &svcsdktypes.Logs{}
		if r.ko.Spec.Logs.Audit != nil {
			f13.Audit = r.ko.Spec.Logs.Audit
		}
		if r.ko.Spec.Logs.General != nil {
			f13.General = r.ko.Spec.Logs.General
		}
		res.Logs = f13
	}
	if r.ko.Spec.MaintenanceWindowStartTime != nil {
		f14 := &svcsdktypes.WeeklyStartTime{}
		if r.ko.Spec.MaintenanceWindowStartTime.DayOfWeek != nil {
			f14.DayOfWeek = svcsdktypes.DayOfWeek(*r.ko.Spec.MaintenanceWindowStartTime.DayOfWeek)
		}
		if r.ko.Spec.MaintenanceWindowStartTime.TimeOfDay != nil {
			f14.TimeOfDay = r.ko.Spec.MaintenanceWindowStartTime.TimeOfDay
		}
		if r.ko.Spec.MaintenanceWindowStartTime.TimeZone != nil {
			f14.TimeZone = r.ko.Spec.MaintenanceWindowStartTime.TimeZone
		}
		res.MaintenanceWindowStartTime = f14
	}
	...
	if r.ko.Spec.Users != nil {
		f20 := []svcsdktypes.User{}
		for _, f20iter := range r.ko.Spec.Users {
			f20elem := &svcsdktypes.User{}
			if f20iter.ConsoleAccess != nil {
				f20elem.ConsoleAccess = f20iter.ConsoleAccess
			}
			if f20iter.Groups != nil {
				f20elem.Groups = aws.ToStringSlice(f20iter.Groups)
			}
			if f20iter.Password != nil {
				tmpSecret, err := rm.rr.SecretValueFromReference(ctx, f20iter.Password)
				if err != nil {
					return nil, ackrequeue.Needed(err)
				}
				if tmpSecret != "" {
					f20elem.Password = aws.String(tmpSecret)
				}
			}
			if f20iter.ReplicationUser != nil {
				f20elem.ReplicationUser = f20iter.ReplicationUser
			}
			if f20iter.Username != nil {
				f20elem.Username = f20iter.Username
			}
