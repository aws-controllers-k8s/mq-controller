...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.EncryptionOptions != nil {
		if desiredKO.Spec.EncryptionOptions.KMSKeyRef != nil {
			if latestKO.Spec.EncryptionOptions == nil {
				latestKO.Spec.EncryptionOptions = &svcapitypes.EncryptionOptions{}
			}
			if latestKO.Spec.EncryptionOptions.KMSKeyRef == nil {
				latestKO.Spec.EncryptionOptions.KMSKeyRef = desiredKO.Spec.EncryptionOptions.KMSKeyRef
			}
		}
	}
